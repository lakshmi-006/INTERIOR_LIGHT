...
// CODE BLOCK BEGIN On_Start FLD_Open
// On start handler "FLD_Open"
void on_start_FLD_Open(void) { try { // on start event
s32 FLD = 0;
s32 interior = 0;
...
// CODE BLOCK END On_Start FLD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbRkxEX09wZW5d,100,-1,6899518804966503580,0
IsExternal=1
ScriptName=FLD_Open
DisplayName=FLD_Open
LastBuildTime=2026-03-29 16:17:18
VarListClose=1
CompileListClose=1
*/
