...
if(FLD==1 && RRD==1 && FRD==1 && interior==1){
app.wait(1000,"");
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbRkxEX0ZSRF9SUkRfT3Blbl0_,100,-1,6072826798915112800,0
IsExternal=1
ScriptName=FLD_FRD_RRD_Open
DisplayName=FLD_FRD_RRD_Open
LastBuildTime=2026-03-29 16:18:13
*/
