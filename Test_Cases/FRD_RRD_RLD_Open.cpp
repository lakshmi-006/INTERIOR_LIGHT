...
// CODE BLOCK BEGIN On_Start FRD_RRD_RLD_Open
// On start handler "FRD_RRD_RLD_Open"
void on_start_FRD_RRD_RLD_Open(void) { try { // on start event
s32 FRD;
s32 RRD;
s32 RLD;
s32 interior;
...
if(FRD==1 && RLD==1 && RRD==1 && interior==1){
app.wait(1000,"");
...
// CODE BLOCK END On_Start FRD_RRD_RLD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbRlJEX1JSRF9STERfT3Blbl0_,100,-1,1324063310104930272,0
IsExternal=1
ScriptName=FRD_RRD_RLD_Open
DisplayName=FRD_RRD_RLD_Open
LastBuildTime=2026-03-29 16:18:25
*/
