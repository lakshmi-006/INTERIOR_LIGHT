...
// CODE BLOCK BEGIN On_Start RLD_RRD_Open
// On start handler "RLD_RRD_Open"
void on_start_RLD_RRD_Open(void) { try { // on start event
s32 RLD;
s32 RRD;
s32 interior;
...
// CODE BLOCK END On_Start RLD_RRD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbUkxEX1JSRF9PcGVuXQ__,100,-1,3125783792632879074,0
IsExternal=1
ScriptName=RLD_RRD_Open
DisplayName=RLD_RRD_Open
LastBuildTime=2026-03-29 16:18:01
*/
