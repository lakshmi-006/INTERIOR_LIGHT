...
// CODE BLOCK BEGIN On_Start RLD_Open
// On start handler "RLD_Open"
void on_start_RLD_Open(void) { try { // on start event
s32 RLD = 0;
s32 interior = 0;
app.set_system_var_int32("Rearleft_Door_Status",1);//door open
...
// CODE BLOCK END On_Start RLD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbUkxEX09wZW5d,100,-1,8000367438821154885,0
IsExternal=1
ScriptName=RLD_Open
DisplayName=RLD_Open
LastBuildTime=2026-03-29 16:17:12
VarListClose=1
*/
