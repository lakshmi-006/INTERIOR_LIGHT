...
// CODE BLOCK BEGIN On_Start FLD_RRD_RLD_Open
// On start handler "FLD_RRD_RLD_Open"
void on_start_FLD_RRD_RLD_Open(void) { try { // on start event
s32 FLD;
s32 RRD;
s32 RLD;
s32 interior;
...
if(FLD==1 && RLD==1 && RRD==1 && interior==1){
app.wait(1000,"");
...
// CODE BLOCK END On_Start FLD_RRD_RLD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbRkxEX1JSRF9STERfT3Blbl0_,100,-1,7269095449992091857,0
IsExternal=1
ScriptName=FLD_RRD_RLD_Open
DisplayName=FLD_RRD_RLD_Open
LastBuildTime=2026-03-29 16:18:19
*/
