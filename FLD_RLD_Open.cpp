...
// CODE BLOCK BEGIN On_Start FLD_RLD_Open
// On start handler "FLD_RLD_Open"
void on_start_FLD_RLD_Open(void) { try { // on start event
s32 FLD;
s32 RLD;
s32 interior;
...
// CODE BLOCK END On_Start FLD_RLD_Open
...
/* 
[UI]
UICommon=0,-1,0,-1,QyBDb2RlIEVkaXRvciBbRkxEX1JMRF9PcGVuXQ__,100,-1,3325912500831370497,0
IsExternal=1
ScriptName=FLD_RLD_Open
DisplayName=FLD_RLD_Open
LastBuildTime=2026-03-29 16:17:37
VarListClose=1
*/
